...
# Database: world
# Generation Time: 2014-08-23 14:00:02 +0000
# ************************************************************
...
INSERT INTO `countries` (`id`, `name`, `continent`, `region`, `surface_area`, `independence_year`, `population`, `life_expectancy`, `gnp`, `gnp_oid`, `local_name`, `government_form`, `head_of_state`, `capital_id`, `code`)
VALUES
